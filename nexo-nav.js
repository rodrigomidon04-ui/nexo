...
(function(){
  ...
  menu.innerHTML=`
    ...
    <div class="nexo-menu-group">
      <div class="nexo-menu-label">Sesiones</div>
    ...
    <div class="nexo-menu-group">
      <div class="nexo-menu-label">Tu red</div>
    ...
    <div class="nexo-menu-group">
      <div class="nexo-menu-label">Tu ecosistema</div>
    ...
    <div class="nexo-menu-group">
      <div class="nexo-menu-label">Acceso rápido</div>
  ...
  // Update account label when authentication/profile data becomes available.
  const refreshAccount=()=>{
    const name=document.getElementById('sideName');
    const btn=document.getElementById('nexoNavAccount');
    if(!btn)return;
    const value=name?.textContent?.trim();
    if(value && value!=='Usuario') btn.innerHTML=`${value} <span class="nexo-chevron">⌄</span>`;
  };
  const observer=new MutationObserver(refreshAccount);
  const sideName=document.getElementById('sideName');
  if(sideName)observer.observe(sideName,{childList:true,subtree:true,characterData:true});
