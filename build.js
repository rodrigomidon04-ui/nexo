...
const scripts = [
  ...
  ['nexo-mi-nexo-members-fix.js?v=1.1-members', '<script src="./nexo-mi-nexo-members-fix.js?v=1.1-members"></script>'],
  ['nexo-inline-mi-nexo.js?v=1.1-inline', '<script src="./nexo-inline-mi-nexo.js?v=1.1-inline"></script>']
];
